...
export const SORT_BY = gql`
	mutation SortListBy($_id: String!, $_sortByVar: String!){
		sortListBy(_id: $_id, sortByVar: $_sortByVar){
		_id
		id
		description
		due_date
...
export const UNDO_SORT_LIST_BY = gql`
	mutation undoSortListBy($_id: String!, $_oldList: [ItemInput]!){
		undoSortListBy(_id: $_id, _oldList: $_oldList){
		_id
		id
		description
		due_date
